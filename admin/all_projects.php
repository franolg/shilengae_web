            ...
            <div class="col-md-12">
              <div class="card ">
                <div class="card-body">
                  ...
                  <hr />
                  <?php
                  $pro = $c->query("SELECT * FROM project ORDER BY id DESC");
                  if($pro->num_rows > 0) {
                    echo '<div class="row">';
                    while ($eex = $pro->fetch_array()) {
                      echo '<div class="col-md-4">
                              ...
                              <a href="all_projects.php?q='.$eex['pid'].'" class="untext btn btn-outline-danger text-white"><i class="material-icons">delete</i> Delete</a>
                              </div>
